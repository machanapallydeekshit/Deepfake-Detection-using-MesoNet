...
def main():
    ...
    # Baseline for SHAP: still using random for demonstration
    # Replace this with a small set of representative images if possible.
    background = np.random.random((1, 256, 256, 3))

    log("Initializing SHAP explainer.")
    explainer = shap.DeepExplainer(meso4_model, background)
